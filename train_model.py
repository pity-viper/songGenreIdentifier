...
def predict_song_genre(file_path, genre="predict"):
    ...
    """
    test_data = []
    test_data.extend(get_feature_vectors(file_path, audio_genre=genre))
